...
class Animal:
    def __init__(self, E_G, P_Am, v, P_M, kappa, k_J, kap_R, E_Hb, E_Hp, kap_X=0.8, kap_P=0.1, E_0=1e6, mu_X=525_000,
                 mu_E=550_000, mu_P=480_000, d_V=0.2, w_V=90):
...
animals = {
    ...
    'squalus_acanthias': dict(E_G=5212.32, P_Am=558.824, v=0.02774, P_M=34.3632, kappa=0.84851, k_J=0.002, kap_R=0.95,
                              E_Hb=7096, E_Hp=300600, E_0=174_619)
}
