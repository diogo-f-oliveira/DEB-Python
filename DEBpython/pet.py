...
class Pet:
    ...
    def __init__(self, p_Am, kap, v, p_M, E_G, k_J, E_Hb, E_Hp, kap_R, comp=None, p_T=0, kap_X=0.8, kap_P=0.1,
...
animals = {
    ...
    'bos_taurus_angus': dict(E_G=7960, p_Am=1584.86, v=0.08859, p_M=21.81, kap=0.9633,
                             ...
                             t_0=84.66, f_milk=1, del_M=0.4481, kap_X=0.09051, rum_fraction=0.3, T=311.75),
    ...
    'bos_taurus_mertolenga': dict(E_G=8880, p_Am=1787, v=0.2361, p_M=24.16, kap=0.9528, k_J=0.002, kap_R=0.95,
                                  ...
                                  kap_X=0.1815, rum_fraction=0.3, T=311.75),
